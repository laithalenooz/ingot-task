                ...
                <div class="grid lg:grid-cols-2 gap-6">
                    ...
                    <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
                        <div class="-mt-4 absolute tracking-wider px-1 uppercase text-xs">
                            <p>
                                <label for="category" class="bg-white text-gray-600 px-1">Income Type *</label>
                            </p>
                        </div>
                        <p>
                            <select name="category" onchange="newCategory(this)" class="py-1 px-1 outline-none block h-full w-full">
                    ...
                    <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
                        ...
                        <p>
                            <input  value="{{@old('amount')}}" id="amount" autocomplete="false" tabindex="0" type="number"
                    ...
                    <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
                        ...
                        <p>
                            <textarea  id="note" autocomplete="false" tabindex="0"
                                       class="py-1 px-1 outline-none block h-full w-full" name="note"></textarea>
                        </p>
                        @error('note')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div id="newCategory" style="display: none;"
                        ...
                        <p>
                            <input name="category_new" id="other" autocomplete="false" tabindex="0" type="text"
